...
namespace SimCaptcha.AspNetCore
{
    ...
    {
        public VCodeImgMiddleware(RequestDelegate next, IOptions<SimCaptchaOptions> optionsAccessor, IMemoryCache memoryCache, IHttpContextAccessor accessor) : base(next, optionsAccessor, memoryCache, accessor)
        { }
